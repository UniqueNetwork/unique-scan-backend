...
export class collectionFkeyAllowNull1659443706703 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "collections" DROP CONSTRAINT "UQ_99da6be64f1143a7284b242860c"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "collections" ADD CONSTRAINT "UQ_99da6be64f1143a7284b242860c" UNIQUE ("collection_id")`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_0c3081d08354c10d3553f4678d0" FOREIGN KEY ("collection_id") REFERENCES "collections"("collection_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
